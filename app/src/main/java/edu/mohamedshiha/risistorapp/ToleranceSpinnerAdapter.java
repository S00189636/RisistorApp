...
public class ToleranceSpinnerAdapter extends ArrayAdapter<ToleranceChart> {
    public ToleranceSpinnerAdapter(@NonNull Context context, ArrayList<ToleranceChart> itemsList) {
