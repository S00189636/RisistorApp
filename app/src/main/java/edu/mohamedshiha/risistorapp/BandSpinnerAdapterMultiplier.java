...
public class BandSpinnerAdapterMultiplier extends ArrayAdapter<BandChart> {
    public BandSpinnerAdapterMultiplier(@NonNull Context context, ArrayList<BandChart> itemsList) {
    ...
    private View InitView(int pos,View convertView,ViewGroup parent){
        ...
        TV_colourValue.setText(" - "+item.getChar());
